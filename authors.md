...
Source:
[`DESCRIPTION`](https://github.com/ggsegverse/ggsegICBM/blob/main/DESCRIPTION)

Mowinckel A, Vidal-Piñeiro D (2026). *ggsegICBM: ICBM Atlas for the
'ggseg' Ecosystem*. R package version 2.0.0,
<https://github.com/ggsegverse/ggsegICBM>.
